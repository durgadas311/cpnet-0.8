...
always$retry	equ	false ; true	; force continuous retries
...
slave$ID	equ	112	; slave processor ID number
...
;	setup of P112's second serial port is done by the BIOS
;	(RDR/PTP devices)

;	we'll just setup the speed

	lxi	h,3			; 38400 baud
	mvi	a,80h
	db	0edh,39h,9bh		; out0 9bh,a
	mov	a,l
	db	0edh,39h,98h		; out0 98h,a
	mov	a,h
	db	0edh,39h,99h		; out0 99h,a
	mvi	a,3
	db	0edh,39h,9bh		; out0 9bh,a
	mvi	a,0
	db	0edh,39h,99h		; out0 99h,a
	mvi	a,3
	db	0edh,39h,9ch		; out0 9ch,a
